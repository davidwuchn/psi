...
1. `munera/open/026-deterministic-agent-workflow-statecharts/`
...
9. `munera/open/027-extension-install-mechanism/`
10. `munera/open/028-project-local-config-precedence/`
