...
1. `munera/open/001-post-wave-b-gordian-follow-on/`
2. `munera/open/002-compatibility-scaffold-removal/`
3. `munera/open/003-prompt-lifecycle-architectural-convergence/`
...
8. `munera/open/012-psi-tool-session-targeting-introspection/`
9. `munera/open/013-work-on-command-noop-regression/`
10. `munera/open/014-psi-tool-code-reload/`
11. `munera/open/015-direct-project-repl-support/`
